...
class User < ActiveRecord::Base
  ...
  def init_cp
    ...
    self.cp_key ||= Mnemonic.encode(master.seed).join(" ")

    self.cp_address ||= Counterparty.new.passphrase_to_address(self.cp_key)
